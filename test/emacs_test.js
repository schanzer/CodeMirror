(function() {
  ...
  function at(line, ch, sticky) { return function(cm) { eqPos(cm.getCursor(), Pos(line, ch, sticky)); }; }
  ...
  sim("motionHWord", "abc. def ghi",
      ...
      "Ctrl-B", "Alt-B", at(0, 5, "before"), "Alt-B", at(0, 0, "after"));
  sim("motionHWordMulti", "abc. def ghi ",
      "Ctrl-3", "Alt-F", at(0, 12, "before"), "Ctrl-2", "Alt-B", at(0, 5, "before"),
